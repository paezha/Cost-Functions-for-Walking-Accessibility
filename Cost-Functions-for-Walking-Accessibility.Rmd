...
author:
  - name: Author
    email: someone@someaddress.edu
    affiliation: Academic Unit
...
In this section we apply the methods discussed in the preceding sections to an empirical case study. Note that the source file for this paper is a reproducible R Notebook which, along with the data files, can be obtained from the following repository:
